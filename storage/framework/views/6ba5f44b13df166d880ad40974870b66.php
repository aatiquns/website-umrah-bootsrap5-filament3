...
<body>
    <nav class="navbar navbar-expand-lg navbar bg-dark border-bottom border-body" data-bs-theme="dark">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(route('home')); ?>">WEBSITE TRAVEL UMRAH</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item mx-2">
                        <a class="nav-link" href="<?php echo e(route('paket')); ?>">Paket Umrah</a>
                    </li>
                </ul>
            </div>
        </div>
...
</html><?php /**PATH C:\laragon\www\website-umroh\resources\views/frontend/layout.blade.php ENDPATH**/ ?>